            ...
            <form action="" className="w-[100%] flex flex-col gap-5">
              <div className="w-[100%] flex gap-2">
                <input
                  ...
                  name="name"
                  placeholder="name"
                  className="w-[100%] p-2 border-1 bg-gray-200 focus:outline-none rounded-md"
                />
                <input
                  type="text"
                  name="email"
              ...
              <textarea
                ...
                cols="30"
                rows="10"
                className="bg-gray-200 rounded-md focus:outline-none p-2"
              ></textarea>
              <button className="bg-black text-white p-2 rounded-2xl hover:bg-slate-700">
                Submit
              </button>
            </form>
          </div>
