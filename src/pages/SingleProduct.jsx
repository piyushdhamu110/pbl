      ...
      <div className="w-[99vw] flex flex-col items-center">
        ...
        <div className="w-[98vw] flex gap-3 p-3 bg-white rounded-2xl">
          ...
          <div className="w-[38%] flex flex-col p-3 gap-2 ">
            ...
            <div className="flex flex-col gap-1">
                    <p className="text-[25px]"> <span className="text-red-400">-70%</span> Rs{product.price}</p>
                    <p className="text-[14px] text-gray-500">M.R.P Rs <span className="line-through">1999</span></p>
                    <p className="text-[14px]">Inclusive all taxes</p>
            </div>
            <hr className="border-black"/>
            <div className="pt-2">
                    <p className="flex items-center gap-2 text-[20px]"><BiSolidOffer className="text-[20px]"/> Offer</p>
                    <div className="flex gap-1">
                              <div className="p-3 shadow-lg">
                                        <p className="font-semibold">Bank Offer</p>
                                        <p className="text-[15px]">10% off on ICICI Bank Credit Card</p>
          ...
          <div className="w-[24%] p-1">
                    <div className="p-4 border border-black rounded-md flex flex-col gap-3">
                              ...
                              <p><span className="text-blue-400">Free Delivery</span> <span className="font-semibold">Tuesday 16 April</span></p>
                              <p>Order within <span className="text-green-500">21hrs 27min.</span></p>
                              <p className="text-blue-400">Details</p>
                              <p className="flex gap-2 items-center"><FaLocationDot /> <span className="text-blue-400">Deliver to AIT, Pune 411553</span></p>
